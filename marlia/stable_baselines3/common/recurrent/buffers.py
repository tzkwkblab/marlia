...
from typing import NamedTuple, Callable, Generator, Optional, Tuple, Union
...
class PredictiveRecurrentRolloutBufferSamples(NamedTuple):
...
class PredictiveRecurrentRolloutBuffer(RecurrentRolloutBuffer):
    def __init__(
        self,
        buffer_size: int,
    ...
    def add(self, *args, next_obs: th.Tensor, **kwargs) -> None:
        if isinstance(self.observation_space, spaces.Discrete):
            next_obs = next_obs.reshape((self.n_envs,) + self.obs_shape)
        self.next_observations[self.pos] = np.array(next_obs).copy()
        super().add(*args, **kwargs)

    def get(self, batch_size: Optional[int] = None) -> Generator[PredictiveRecurrentRolloutBufferSamples, None, None]:
    ...
    def _get_samples(
    ...
    ) -> PredictiveRecurrentRolloutBufferSamples:
        ...
        return PredictiveRecurrentRolloutBufferSamples(
